  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center relative z-10 ">
        <a className="cursor-pointer text-white px-10 py-[0.85rem] bg-gradient-to-br from-[#A8EB12,35%] to-[#2CD261]  flex font-semibold  text-2xl rounded-md hover:translate-y-[-.25rem] transition-all duration-500">
          Get Started{" "}
