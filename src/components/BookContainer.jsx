...
export default function BookContainer({ settingFiltered, info }) {
  ...
  return (
    <div className="text-white max-w-7xl mx-auto h-full flex justify-center relative z-0 pb-4 xxs:pb-0  lg:pb-8 xs:min-h-screen">
      ...
      <div className=" w-[50rem] h-[30rem] md:w-[40rem] sm:w-[30rem] xxs:h-[35rem]  md:h-[26.5rem] bg-[#ffffff36] mt-12 rounded-lg ">
